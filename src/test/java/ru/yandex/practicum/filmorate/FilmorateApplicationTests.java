...
class FilmorateApplicationTests {
	...
	void testFilmName() {
		...
		film.setDuration(123);
		ValidationException validationException = assertThrows(ValidationException.class, () -> film.validate());
	...
	void testUserEmailBlank() {
		...
		user.setName("Boss");
		user.setBirthday(LocalDate.of(2000, 1, 29));
		ValidationException validationException = assertThrows(ValidationException.class, () -> user.validate());
