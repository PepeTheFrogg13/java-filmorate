...
ALTER TABLE "UserFriends" ADD CONSTRAINT IF NOT EXISTS "fk_UserFriends_UserSenderId" FOREIGN KEY("UserSenderId") REFERENCES "User" ("UserID");
ALTER TABLE "UserFriends" ADD CONSTRAINT IF NOT EXISTS "fk_UserFriends_UserRecipientId" FOREIGN KEY("UserRecipientId") REFERENCES "User" ("UserID");
...
ALTER TABLE "Film" ADD CONSTRAINT IF NOT EXISTS "fk_Film_RatingId" FOREIGN KEY("RatingId") REFERENCES "Rating" ("RatingId");
ALTER TABLE "FilmGenre" ADD CONSTRAINT IF NOT EXISTS "fk_FilmGenre_FilmId" FOREIGN KEY("FilmId") REFERENCES "Film" ("FilmId");
ALTER TABLE "FilmGenre" ADD CONSTRAINT IF NOT EXISTS "fk_FilmGenre_GenreId" FOREIGN KEY("GenreId") REFERENCES "Genre" ("GenreId");
