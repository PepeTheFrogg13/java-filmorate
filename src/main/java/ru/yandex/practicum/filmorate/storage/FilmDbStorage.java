...
public class FilmDbStorage extends BaseRepository<Film> implements FilmStorage {
    ...
    private static final String FIND_ALL_FILMS =
            "SELECT \"Film\".*, \"Rating\".\"Name\" AS \"RatingName\" " +
                    "FROM \"Film\" " +
    ...
    private static final String INSERT_FILM_GENRE =
            "MERGE INTO \"FilmGenre\" (\"FilmId\",\"GenreId\") KEY(\"FilmId\",\"GenreId\") VALUES (?,?);";

    private static final String UPDATE_FILM =
            "UPDATE \"Film\" SET \"Name\" = ?, \"Description\" = ?, \"ReleaseDate\" = ?, \"Duration\" = ? " +
                    "WHERE \"FilmId\" = ?;";

    private static final String DELETE_FILM = "DELETE FROM \"Film\" WHERE \"FilmId\" = ?;";
    ...
    private static final String DELETE_FILM_GENRE =
            "DELETE FROM \"FilmGenre\" WHERE \"FilmId\" = ? AND \"GenreId\" = ?;";
    private static final String DELETE_FILM_LIKES = "DELETE FROM \"FilmLikes\" WHERE \"FilmId\" = ?;";

    private static final String INSERT_LIKE =
            "MERGE INTO \"FilmLikes\" (\"FilmId\",\"UserID\") KEY (\"FilmId\",\"UserID\") VALUES (?,?);";
    private static final String DELETE_LIKE =
            "DELETE FROM \"FilmLikes\" WHERE \"FilmId\" = ? AND \"UserID\" = ?;";
